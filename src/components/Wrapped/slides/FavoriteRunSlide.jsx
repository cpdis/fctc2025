...
export default function FavoriteRunSlide({ stats, clubData }) {
  ...
  if (isClub) {
    ...
    return (
      <div className="min-h-screen-ios flex flex-col items-center justify-center p-4 pb-20 sm:p-8 bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-700 relative overflow-hidden">
        {/* Background glow */}
        <motion.div
  ...
  if (!favorite) {
    return (
      <div className="min-h-screen-ios flex items-center justify-center p-4 pb-20 sm:p-8 bg-gradient-to-br from-purple-900 to-blue-700">
