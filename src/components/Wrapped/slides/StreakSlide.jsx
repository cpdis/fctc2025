...
export default function StreakSlide({ stats, clubData }) {
  ...
  if (isClub) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-orange-900 via-red-800 to-pink-700 relative overflow-hidden">
        {/* Background flames */}
        <motion.div
