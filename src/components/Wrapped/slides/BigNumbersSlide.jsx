...
export default function BigNumbersSlide({ stats, clubData }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 pb-20 sm:p-8 bg-gradient-to-br from-mocha via-coffee to-terracotta relative overflow-hidden">
