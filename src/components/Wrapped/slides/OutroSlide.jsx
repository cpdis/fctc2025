...
export default function OutroSlide({ stats, clubData, onRestart }) {
  ...
  return (
    <div className="min-h-screen-ios flex flex-col items-center justify-center p-4 pb-24 sm:p-8 bg-gradient-to-br from-navy via-navy-light to-pink-dark relative overflow-hidden">
