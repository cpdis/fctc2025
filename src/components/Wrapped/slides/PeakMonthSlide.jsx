...
export default function PeakMonthSlide({ stats, clubData }) {
  ...
  if (!peakMonth) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 pb-20 sm:p-8 bg-gradient-to-br from-cyan-900 to-blue-700">
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 pb-20 sm:p-8 bg-gradient-to-br from-cyan-900 via-teal-800 to-emerald-700">
      <motion.div
