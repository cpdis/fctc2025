...
export default function TopAttendeeSlide({ stats, clubData }) {
  ...
  if (isClub) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-amber-900 via-yellow-800 to-amber-600 relative overflow-hidden">
